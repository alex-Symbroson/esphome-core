...
float ESP32BLEBeacon::get_setup_priority() const { return setup_priority::HARDWARE_LATE; }
...
void ESP32BLEBeacon::set_major(uint16_t major) { this->major = major; }
void ESP32BLEBeacon::set_minor(uint16_t minor) { this->minor = minor; }
