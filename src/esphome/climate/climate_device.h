#ifndef ESPHOME_CORE_CLIMATE_H
#define ESPHOME_CORE_CLIMATE_H
...
class ClimateCall {
 public:
  explicit ClimateCall(ClimateDevice *parent) : parent_(parent) {}
...
class ClimateDevice : public Nameable {
 public:
  ...
  ClimateDevice(const std::string &name);
